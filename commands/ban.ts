import { SlashCommandBuilder, PermissionFlagsBits, InteractionContextType, MessageFlags, ChatInputCommandInteraction, GuildMember, TextChannel } from "discord.js";
...
export async function execute(interaction: ChatInputCommandInteraction) {
  ...
  await (client.channels.cache.get("1001166932407496754") as TextChannel).send({
    embeds: [
      {
        color: 0xf04a47,
